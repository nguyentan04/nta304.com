...
export const computePairAddress = ({
  ...
  tokenA,
  tokenB,
}: ComputePairAddressParam): string => {
...
export class Pair {
  ...
  public static getAddress(initCodeHash: string, factoryAddress: string, tokenA: Token, tokenB: Token): string {
  ...
  public constructor(
    ...
    this.liquidityToken = new Token(
      ...
      Pair.getAddress(initCodeHash, factoryAddress, tokenAmounts[0].currency, tokenAmounts[1].currency),
      18,
      'UNI-V2',
      'Uniswap V2',
    );
