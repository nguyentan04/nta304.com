                ...
                var b = function(t, e, r, n) {
                    ...
                    _ = function(t) {
                        ...
                        return e = p, (r = [{
                            ...
                            value: function() {
                                b(this, void 0, void 0, f().mark((function t() {
                                    return f().wrap((function(t) {
                                        for (;;) switch (t.prev = t.next) {
                                            case 0:
                                                ...
                                                return t.next = 3, this.props.init(d.tsParticles);
                                            case 3:
                            ...
                            key: "refresh",
                            value: function() {
                                return b(this, void 0, void 0, f().mark((function t() {
                                    return f().wrap((function(t) {
                                        for (;;) switch (t.prev = t.next) {
                                            case 0:
                            ...
                            value: function() {
                                var t;
                                return b(this, void 0, void 0, f().mark((function e() {
                                    var r, n, o = this;
                                    return f().wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            case 0:
                                                ...
                                                return e.next = 4, d.tsParticles.loadJSON(this.props.id, this.props.url);
                                            case 4:
                                                e.t0 = e.sent, e.next = 10;
                                                break;
                                            case 7:
                                                return e.next = 9, d.tsParticles.load(this.props.id, null !== (t = this.props.params) && void 0 !== t ? t : this.props.options);
                                            case 9:
                                                e.t0 = e.sent;
                                            case 10:
