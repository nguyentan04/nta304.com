...
function _e(e, t = {}, r, o) {
    let {
        ...
        refName: a = "ref",
        ...l
    } = gt(e, ["unmount", "static"]), s = e.ref !== void 0 ? {
        [a]: e.ref
    ...
    if (l.className && typeof l.className == "function" && (l.className = l.className(t)), n === oo && Object.keys(l).length > 0) {
        if (!cr(u) || Array.isArray(u) && u.length > 1) throw new Error(['Passing props on "Fragment"!', "", `The current component <${o} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(l).map(c => `  - ${c}`).join(`
...
var Or = Cr,
    ...
    Dr = D(function(t, r) {
        ...
        let {
            ...
            displayValue: i,
            ...a
        } = t, [l, s] = pe("Combobox.Input"), u = Ue(), c = I(l.inputRef, r), m = l.inputPropsRef, b = `headlessui-combobox-input-${A()}`, T = Q(), y = ke(n);
        x(() => {
    ...
    Fr = D(function(t, r) {
        var p;
        let [o, n] = pe("Combobox.Button"), i = Ue(), a = I(o.buttonRef, r), l = `headlessui-combobox-button-${A()}`, s = Q(), u = B(f => {
            switch (f.key) {
                case "ArrowDown":
...
function kr(e) {
    let [t] = pe("Combobox.Label"), r = `headlessui-combobox-label-${A()}`, o = B(() => {
        var a;
...
var _r = "ul",
    ...
    Hr = D(function(t, r) {
        ...
        let {
            hold: o = !1,
            ...n
        } = t, [i] = pe("Combobox.Options"), {
            optionsPropsRef: a
        } = i, l = I(i.optionsRef, r), s = `headlessui-combobox-options-${A()}`, u = _(), c = (() => u !== null ? u === 0 : i.comboboxState === 0)();
        x(() => {
            var p;
...
function Br(e) {
    let {
        ...
        value: r,
        ...o
    } = e, [n, i] = pe("Combobox.Option"), a = Ue(), l = `headlessui-combobox-option-${A()}`, s = n.activeOptionIndex !== null ? n.options[n.activeOptionIndex].id === l : !1, u = n.comboboxPropsRef.current.value === r, c = He({
        disabled: t,
        value: r
    });
    x(() => {
    ...
    x(() => {
        ...
        return document.querySelectorAll("body > *").forEach(o => {
            ...
            if (fe.delete(r), fe.size > 0) document.querySelectorAll("body > *").forEach(o => {
                ...
                for (let o of J.keys()) co(o), J.delete(o)
        }
    }, [t])
}
import Qr, {
...
function We(e) {
    let t = e,
        r = Xr(),
        [o] = go(() => typeof window == "undefined" ? null : document.createElement("div")),
        n = q();
    return x(() => {
...
function re() {
    let [e, t] = ln([]);
    return [e.length > 0 ? e.join(" ") : void 0, xo(() => function(o) {
        let n = rn(a => (t(l => [...l, a]), () => t(l => {
                let s = l.slice(),
                    u = s.indexOf(a);
...
function Eo({
    ...
    return x(() => (i(0, r, o), () => i(1, r, o)), [i, r, o]), sn.createElement(ht.Provider, {
        value: i
    }, e)
}
var yn = {
...
var Pn = "div",
    ...
    vn = D(function(t, r) {
        ...
        let [N, K] = re(), V = `headlessui-dialog-${A()}`, Fe = je(() => [{
            dialogState: p,
            close: C,
            setTitleId: R
        }, d], [p, d, C, R]), ge = je(() => ({
    ...
    En = D(function(t, r) {
        let [{
            dialogState: o,
            close: n
        }] = It("Dialog.Overlay"), i = I(r), a = `headlessui-dialog-overlay-${A()}`, l = Ke(m => {
...
function Sn(e) {
    let [{
        dialogState: t,
        setTitleId: r
    }] = It("Dialog.Title"), o = `headlessui-dialog-title-${A()}`;
    Ot(() => (r(o), () => r(null)), [o, r]);
    let n = je(() => ({
        open: t === 0
    }), [t]);
...
function Ye(e) {
    let {
        defaultOpen: t = !1,
        ...r
    } = e, o = `headlessui-disclosure-button-${A()}`, n = `headlessui-disclosure-panel-${A()}`, i = On(Mn, {
...
var wn = "button",
    kn = D(function(t, r) {
        let [o, n] = Ft("Disclosure.Button"), i = In(null), a = I(i, r), l = Dn(), s = l === null ? !1 : l === o.panelId, u = Qe(f => {
            var d;
            if (s) {
        ...
        }, [n, s, o.disclosureState, o.buttonId]), c = Qe(f => {
            switch (f.key) {
                case " ":
                    f.preventDefault();
                    break
        ...
        }, [n, t.disabled, o.buttonId, s]), b = ze(() => ({
...
function Ee(e) {
    let {
        ...
        horizontal: n = !1,
        ...i
    } = e, a = n ? "horizontal" : "vertical", l = jn(Qn, {
        listboxState: 1,
        propsRef: {
            current: {
                value: t,
...
var zn = "button",
    Yn = D(function(t, r) {
        var p;
        let [o, n] = Re("Listbox.Button"), i = I(o.buttonRef, r), a = `headlessui-listbox-button-${A()}`, l = Q(), s = z(f => {
            switch (f.key) {
                case " ":
                case "Enter":
                case "ArrowDown":
...
function Jn(e) {
    let [t] = Re("Listbox.Label"), r = `headlessui-listbox-label-${A()}`, o = z(() => {
        var a;
...
function ri(e) {
    let {
        ...
        value: r,
        ...o
    } = e, [n, i] = Re("Listbox.Option"), a = `headlessui-listbox-option-${A()}`, l = n.activeOptionIndex !== null ? n.options[n.activeOptionIndex].id === a : !1, s = n.propsRef.current.value === r, u = Vn({
        disabled: t,
        value: r
    });
    x(() => {
...
var ci = "button",
        ...
        var y;
        let [o, n] = Je("Menu.Button"), i = I(o.buttonRef, r), a = `headlessui-menu-button-${A()}`, l = Q(), s = Y(p => {
            switch (p.key) {
                case " ":
                case "Enter":
                case "ArrowDown":
...
function gi(e) {
    let {
        ...
        onClick: r,
        ...o
    } = e, [n, i] = Je("Menu.Item"), a = `headlessui-menu-item-${A()}`, l = n.activeItemIndex !== null ? n.items[n.activeItemIndex].id === a : !1;
    x(() => {
...
function Te(e) {
    ...
    be(() => c == null ? void 0 : c(s), [c, s]), w("focus", () => {
        n === 0 && (m() || !i || !a || l({
            type: 1
        }))
    }, !0), w("mousedown", p => {
...
var Si = "button",
    Ai = D(function(t, r) {
        let [o, n] = ot("Popover.Button"), i = Se(null), a = Fo(), l = a == null ? void 0 : a.closeOthers, s = Ri(), u = s === null ? !1 : s === o.panelId, c = I(i, r, u ? null : g => n({
            type: 2,
            button: g
        })), m = I(i, r), b = Se(null), T = Se(typeof window == "undefined" ? null : document.activeElement);
        w("focus", () => {
    ...
    Ii = D(function(t, r) {
        let [{
            popoverState: o
        }, n] = ot("Popover.Overlay"), i = I(r), a = `headlessui-popover-overlay-${A()}`, l = _(), s = (() => l !== null ? l === 0 : o === 0)(), u = j(T => {
    ...
    Mi = D(function(t, r) {
        let {
            focus: o = !1,
            ...n
        } = t, [i, a] = ot("Popover.Panel"), {
            close: l
        } = Mo("Popover.Panel"), s = Se(null), u = I(s, r, p => {
            a({
                type: 4,
                panel: p
            })
        }), c = _(), m = (() => c !== null ? c === 0 : i.popoverState === 0)(), b = j(p => {
            var f;
            switch (p.key) {
                case "Escape":
        ...
        }, [i.popoverState, t.unmount, t.static, a]), be(() => {
...
function wo(e = 0) {
    let [t, r] = ki(e), o = rt(l => r(s => s | l), [r]), n = rt(l => Boolean(t & l), [t]), i = rt(l => r(s => s & ~l), [r]), a = rt(l => r(s => s ^ l), [r]);
    return {
        addFlag: o,
        hasFlag: n,
        removeFlag: i,
...
function Ae() {
    let [e, t] = Bi([]);
    return [e.length > 0 ? e.join(" ") : void 0, ko(() => function(o) {
        let n = Hi(a => (t(l => [...l, a]), () => t(l => {
                let s = l.slice(),
                    u = s.indexOf(a);
                return u !== -1 && s.splice(u, 1), s
            })), []),
        ...
        return _i.createElement(_o.Provider, {
            value: i
        }, o.children)
    }, [t])]
}
...
function lt(e) {
    let {
        ...
        options: []
    }), [l, s] = Ae(), [u, c] = re(), m = `headlessui-radiogroup-${A()}`, b = Kt(null), T = it(() => i.find(R => !R.propsRef.current.disabled), [i]), y = it(() => i.some(R => R.propsRef.current.value === t), [i, t]), p = ye(R => {
        var v;
        if (o || R === t) return !1;
    ...
    let f = ye(R => {
            if (!b.current) return;
            let v = i.filter(h => h.propsRef.current.disabled === !1).map(h => h.element.current);
            switch (R.key) {
                case "ArrowLeft":
                case "ArrowUp":
                ...
                case " ":
                    {
                        R.preventDefault(),
                        R.stopPropagation();
                        let h = i.find(O => O.element.current === document.activeElement);h && p(h.propsRef.current.value)
                    }
                    break
            }
        }, [b, i, p]),
...
function ol(e) {
    let [t, r] = Zi(null), [o, n] = Ae(), [i, a] = re(), l = Uo(() => ({
        switch: t,
        setSwitch: r,
        labelledby: o,
        describedby: i
    }), [t, r, o, i]);
    return Vt.createElement(a, {
...
function Qt(e) {
    let {
        ...
        onChange: r,
        ...o
    } = e, n = `headlessui-switch-${A()}`, i = Ji($t), a = el(null), l = I(a, i === null ? null : i.setSwitch), s = at(() => r(!t), [r, t]), u = at(y => {
        if (G(y.currentTarget)) return y.preventDefault();
        y.preventDefault(), s()
    }, [s]), c = at(y => {
        y.key !== "Tab" && y.preventDefault(), y.key === " " && s()
    }, [s]), m = at(y => y.preventDefault(), []), b = Uo(() => ({
        checked: t
    }), [t]), T = {
        id: n,
        ref: l,
...
function cl(e) {
    let {
        ...
        ...a
    } = e, l = r ? "vertical" : "horizontal", s = o ? "manual" : "auto", [u, c] = sl(pl, {
        selectedIndex: null,
        tabs: [],
        panels: [],
        orientation: l,
    ...
    return nl.createElement(zt.Provider, {
        value: y
    }, E({
        props: { ...a
        },
...
function xl(e) {
    ...
    let [{
        ...
        dispatch: n
    }] = Le("Tab.Panel"), i = `headlessui-tabs-panel-${A()}`, a = st(null), l = I(a, p => {
        !p || n({
            type: 7
        })
    });
...
function El(e, t) {
    ...
    let {
        ...
        transitionDelay: n
    } = getComputedStyle(e), [i, a] = [o, n].map(l => {
...
function ft(e) {
    return "children" in e ? ft(e.children) : e.current.filter(({
        state: t
    }) => t === "visible").length > 0
}
...
function zo(e) {
    let {
        ...
        leaveTo: m,
        ...b
    } = e, T = Me(null), [y, p] = Vo("visible"), f = b.unmount ? 0 : 1, {
        show: d,
        appear: P,
        initial: C
    } = Cl(), {
    ...
    let H = {
        ...
        Pe = b;
    return ie.createElement(ct.Provider, {
        value: O
    }, ie.createElement(W, {
        value: S(y, {
            visible: 0,
...
function mt(e) {
    ...
    if (t === void 0 && i !== null && (t = S(i, {
            [0]: !0,
            [1]: !1
        })), ![!0, !1].includes(t)) throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
    let [a, l] = Vo(t ? "visible" : "hidden"), s = $o(() => {
        l("hidden")
    }), u = Bo(), c = Zt(() => ({
        show: t,
        appear: r || !u,
    ...
    return ie.createElement(ct.Provider, {
        value: s
    }, ie.createElement(dt.Provider, {
        value: c
    }, E({
        props: { ...m,
            as: Wo,
            children: ie.createElement(zo, { ...m,
                ...n
            })
        },
        defaultTag: Wo,
...
mt.Child = function(t) {
    let r = Jt(dt) !== null,
        o = _() !== null;
    return !r && o ? ie.createElement(mt, { ...t
    }) : ie.createElement(zo, { ...t
    })
};
mt.Root = mt;
export {
    Na as Combobox, An as Dialog, Ye as Disclosure, yu as FocusTrap, Ee as Listbox, Ze as Menu, Te as Popover, We as Portal, lt as RadioGroup, Qt as Switch, De as Tab, mt as Transition
};